...
function $$SETUP_STATE(hydrateRuntimeState, basePath) {
  return hydrateRuntimeState(JSON.parse('{\
    ...
    "dependencyTreeRoots": [\
      {\
        "name": "secp256k1-resolution-test",\
        "reference": "workspace:."\
      }\
    ],\
    ...
    "fallbackExclusionList": [\
      ["secp256k1-resolution-test", ["workspace:."]]\
    ],\
    "fallbackPool": [\
    ],\
    "packageRegistryData": [\
      [null, [\
        [null, {\
          ...
          "packageDependencies": [\
            ...
            ["secp256k1", [\
              "@metamask/noble-secp256k1-compat-wrapper",\
              "npm:1.0.3"\
            ]]\
          ],\
          "linkType": "SOFT"\
      ...
      ["@metamask/noble-secp256k1-compat-wrapper", [\
        ["npm:1.0.3", {\
          "packageLocation": "./.yarn/cache/@metamask-noble-secp256k1-compat-wrapper-npm-1.0.3-3bfa58f84e-a4e9d110b3.zip/node_modules/@metamask/noble-secp256k1-compat-wrapper/",\
          "packageDependencies": [\
            ["@metamask/noble-secp256k1-compat-wrapper", "npm:1.0.3"],\
